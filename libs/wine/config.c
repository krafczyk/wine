...
wine_patch_data[] =
{
    ...
    { "Anton Baskanov", "user32: Set correct caret state in the server in SetCaretPos.", 4 },
    ...
    { "Sebastian Lackner", "ntdll: Receive debug registers from server on x86_64.", 1 },
    ...
    { "Sebastian Lackner", "ntdll/tests: Add tests for setting debug registers with NtSetContextThread.", 1 },
    ...
    { "Sebastian Lackner", "oleaut32: Align terminating null character in SysAllocStringByteLen.", 1 },
    ...
    { "Sebastian Lackner", "oleaut32: Pass size without terminating null to get_cache_entry.", 1 },
    { "Sebastian Lackner", "oleaut32/tests: Add a test for TKIND_COCLASS in proxy/stub marshalling.", 1 },
    { "Sebastian Lackner", "oleaut32/tests: Test SysStringLen() on string allocated with SysAllocStringByteLen.", 1 },
    ...
    { "Sebastian Lackner", "server: Implement wineserver call for SystemHandleInformation.", 2 },
