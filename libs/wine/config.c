...
wine_patch_data[] =
{
    ...
    { "Dmitry Timoshkov", "shlwapi: Fix IStream::Read() return value for partial reads.", 1 },
    { "Dmitry Timoshkov", "tools/wrc: Fix generation of custom dialog control data.", 1 },
    { "Dmitry Timoshkov", "user32: Avoid dereferencing NULL pointer in a trace.", 1 },
    { "Dmitry Timoshkov", "user32: Change value for WM_MDICALCCHILDSCROLL to 0x003f.", 1 },
    { "Dmitry Timoshkov", "user32: Enable correct dialog owner.", 1 },
    { "Dmitry Timoshkov", "user32: Enable the specified dialog owner.", 1 },
    ...
    { "Dmitry Timoshkov", "user32/tests: Add some tests for dialog owner disabled state.", 3 },
    ...
    { "Dmitry Timoshkov", "user32: Unconditionally enable dialog owner.", 1 },
    ...
    { "Hugh McMaster", "reg: Add support for querying the registry with the /v and /ve switches.", 2 },
    { "Hugh McMaster", "reg: Query all values and subkeys in a specified key.", 2 },
    ...
    { "Michael Müller", "dwmapi: Return S_OK from DwmSetWindowAttribute function.", 1 },
    ...
    { "Michael Müller", "kernel32/tests: Add additional tests for overlapped handling of CreateNamedPipe.", 1 },
    ...
    { "Michael Müller", "winex11: Add 320x240 as supported resolution in desktop mode.", 1 },
    ...
    { "Michael Müller", "wininet: Set default HTTP port correctly when passing INTERNET_FLAG_SECURE to InternetConnect.", 1 },
    ...
    { "Michael Müller", "ws2_32: Add semi-stub for DisconnectEx.", 1 },
    { "Michael Müller", "ws2_32: Ignore socket type for protocol IPPROTO_IPV6 in getaddrinfo.", 1 },
    { "Michael Müller", "ws2_32/tests: Add tests for DisconnectEx.", 1 },
    ...
    { "Sebastian Lackner", "advapi32: Fix return value of RegNotifyChangeKeyValue for pending events.", 1 },
    ...
    { "Sebastian Lackner", "msi: Fix stack alignment in CUSTOMPROC_wrapper.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Do not update iosb.Status after FSCTL_PIPE_LISTEN call.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Handle stack guard pages on x86_64.", 1 },
    ...
    { "Sebastian Lackner", "ntdll/tests: Add tests for iosb.Status value after pending FSCTL_PIPE_LISTEN call.", 1 },
    ...
    { "Sebastian Lackner", "user32: Do not block sending/posting WM_NOTIFY messages.", 1 },
    ...
    { "Sebastian Lackner", "wined3d: Add warning that CSMT patchset is disabled.", 1 },
