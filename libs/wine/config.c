...
wine_patch_data[] =
{
    ...
    { "Dmitry Timoshkov", "windowscodecs: Avoid extra conversion step BGR->RGB when converting 32bpp BGRA to 24bpp RGB.", 1 },
    ...
    { "Dmitry Timoshkov", "windowscodecs: Return S_OK from PngFrameEncode_SetPalette.", 1 },
    ...
    { "Michael Müller", "wined3d: Add WINED3DFMT_R32G32_{U,S}INT as render target format.", 1 },
    ...
    { "Sebastian Lackner", "include: Avoid shift overflow warning.", 1 },
