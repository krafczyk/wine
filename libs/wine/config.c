...
wine_patch_data[] =
{
    ...
    { "Matteo Bruni", "msctf: Add a partial implementation of ITfThreadMgrEx_ActivateEx().", 1 },
    ...
    { "Sebastian Lackner", "oleaut32/tests: Add test for calling method with coclass argument.", 1 },
    ...
    { "Sebastian Lackner", "Revert \"wined3d: Prepare GL resources before calling context_apply_fbo_state.\".", 1 },
