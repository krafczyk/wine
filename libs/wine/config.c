...
wine_patch_data[] =
{
    ...
    { "Anton Baskanov", "quartz: Handle NULL target format in FilterGraph::ConvertTimeFormat.", 2 },
    ...
    { "Austin English", "rpcrt4: Add a stub for RpcBindingServerFromClient.", 1 },
    ...
    { "Jarkko Korpi", "user32: Remove dead code from SCROLL_TrackScrollBar.", 1 },
    ...
    { "Michael Stefaniuc", "dmime: Do not pass both DSBCAPS_CTRLPAN and DSBCAPS_CTRL3D to dsound.", 1 },
