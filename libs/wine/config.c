...
wine_patch_data[] =
{
    ...
    { "Alistair Leslie-Hughes", "d3dx9_36: Add D3DXCreateAnimationController tests.", 1 },
    ...
    { "Alistair Leslie-Hughes", "d3dx9_36: Store all values passed to the create and return them in the correct functions.", 1 },
    ...
    { "Austin English", "kernel32: add SetConsoleKeyShortcuts stub.", 1 },
    ...
    { "Bruno Jesus", "include: Add stuff related to WSAPoll().", 2 },
    { "Bruno Jesus", "ws2_32: Add WSAPoll() implementation.", 1 },
    { "Bruno Jesus", "ws2_32/tests: Add WSAPoll() tests.", 1 },
    ...
    { "Dmitry Timoshkov", "dlls/ole32: Handle failure of reading directory entry in IEnumSTATSTG::Next.", 1 },
    { "Dmitry Timoshkov", "dlls/ole32: Zero out returned stats when IEnumSTATSTG::Next reaches end of enumeration.", 1 },
    ...
    { "Dmitry Timoshkov", "ole32/tests: Add the tests to show that IEnumSTATSTG::Next should zero out returned stats when it reaches end of enumeration.", 1 },
    { "Dmitry Timoshkov", "oleaut32/tests: Add a bunch of new tests for typelib generation.", 1 },
    ...
    { "Dmitry Timoshkov", "widl: Attributes of the alias are supposed to replace attributes of a tag in the typelib. Resend.", 1 },
    { "Dmitry Timoshkov", "widl: Attribute uuid() takes precedence over 'hidden'. Resend.", 1 },
    { "Dmitry Timoshkov", "widl: Avoid generating duplicate typelib entries for structure tag names. Resend.", 1 },
    { "Dmitry Timoshkov", "widl: Ignore assignment of a duplicate uuid. Resend.", 1 },
    ...
    { "Hugh McMaster", "kernel32: Implement GetConsoleFontSize (v2, resend).", 1 },
    { "Hugh McMaster", "kernel32: Implement GetNumberOfConsoleFonts.", 1 },
    { "Hugh McMaster", "kernel32/tests: Add tests for GetConsoleFontSize (v2, resend).", 1 },
    { "Hugh McMaster", "wineconsole: Add if check to determine whether a font attribute has changed.", 3 },
    { "Hugh McMaster", "wineconsole: Pass font size information to wineserver.", 1 },
    ...
    { "Jiaxing Wang", "regedit: Need 3 bytes of room at end of buffer for \\\\r\\\\n\\\\0 to avoid endless loop.", 1 },
    ...
    { "Michael Müller", "sfc_os: Implement SfcGetNextProtectedFile.", 1 },
    ...
    { "Michael Müller", "winedbg: Print windows version in system info.", 1 },
    ...
    { "Nikolay Sivov", "comctl32: Protect TVM_GETITEM from invalid item pointers.", 1 },
    ...
    { "Sebastian Lackner", "dinput: Ensure X11 input events are handled even without explicit message loop.", 4 },
    ...
    { "Sebastian Lackner", "kernel32/tests: Add tests for behaviour of WriteFile on closed pipe.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Block signals while executing system APCs.", 1 },
    ...
    { "Sebastian Lackner", "ntdll/tests: Add more tests for SystemHandleInformation.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: When handling stack faults also commit the page, instead of just removing the guard page flag.", 1 },
    ...
    { "Sebastian Lackner", "server: Fix wineserver crash when pipe server object is destroyed before client.", 1 },
    ...
    { "Sebastian Lackner", "server: Implement wineserver call for SystemHandleInformation.", 1 },
    ...
    { "Sebastian Lackner", "server: Move parent reference from object_name to object.", 1 },
    ...
    { "Sebastian Lackner", "server: Store a reference to the parent object for pipe servers.", 1 },
    ...
    { "Sebastian Lackner", "widl: When adding an interface typedef do check whether it has been already added while resolving the parent interface.", 1 },
