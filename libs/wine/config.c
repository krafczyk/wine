...
wine_patch_data[] =
{
    ...
    { "Alexander Law", "user32: Replicate Windows behavior of WM_SETTEXT handler regarding WM_CTLCOLOR*.", 1 },
    ...
    { "Michael Müller", "compobj.dll16: StringFromGUID2 must write a char string into the buffer.", 1 },
    ...
    { "Michael Müller", "kernel32: Check for invalid filename pointers in CreateFileA in Win 9X mode.", 1 },
    { "Michael Müller", "kernel32: Implement GetFinalPathNameByHandle.", 1 },
    { "Michael Müller", "kernel32: Set ERROR_DLL_NOT_FOUND as error code for Win 9X instead of ERROR_MOD_NOT_FOUND.", 1 },
    ...
    { "Michael Müller", "krnl386.exe16: Emulate 'mov Eb, Gb' instruction on x86 processor architecture.", 1 },
    ...
    { "Sebastian Lackner", "configure.ac: Fix cross-compiling of 32-bit Wine for OSX.", 1 },
    ...
    { "Sebastian Lackner", "makefiles: Do not generate Makefile for disabled rules.", 1 },
    ...
    { "Sebastian Lackner", "Revert \"wined3d: Avoid surface_from_resource() in swapchain_gl_frontbuffer_updated().\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Avoid surface_from_resource() in texture2d_prepare_texture().\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Avoid surface_from_resource() in wined3d_texture_update_desc().\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Avoid volume_from_resource() in texture3d_prepare_texture().\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Call wglGetPixelFormat() through the gl_ops table.\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Call wined3d_texture_set_dirty() in wined3d_volume_invalidate_location().\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Cleanup sub-resource buffer objects in wined3d_texture_cleanup().\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Get rid of the offscreenBuffer field in struct wined3d_device.\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Get rid of wined3d_surface_ops.surface_unmap().\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Handle slice pitch and alignment as well in wined3d_format_calculate_pitch().\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Introduce wined3d_texture_check_block_align().\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Introduce wined3d_texture_get_pitch().\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Keep track of front buffer updates in the swapchain.\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Merge surface_prepare_buffer() and wined3d_volume_prepare_pbo().\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Merge surface_remove_pbo() and wined3d_volume_free_pbo().\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Store custom pitches in the texture instead of the surface.\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Store surface/volume buffer objects in the sub-resource structure.\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Store the \"user_memory\" pointer in the texture instead of the surface.\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Use a single allocation for texture sub-resource objects.\".", 1 },
    { "Sebastian Lackner", "Revert \"wined3d: Use wined3d_format_calculate_pitch() in surface_download_data().\".", 1 },
    ...
    { "Sebastian Lackner", "setupapi: Fix parsing of inf files containing garbage at the beginning.", 1 },
    ...
    { "Sebastian Lackner", "user32: Allow to send/post intra-process WM_NOTIFY messages.", 1 },
    ...
    { "Sebastian Lackner", "user32/tests: Add additional tests for window station name.", 1 },
    { "Sebastian Lackner", "user32/tests: Add tests for button WM_CTLCOLOR* messages.", 1 },
