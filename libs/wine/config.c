...
wine_patch_data[] =
{
    ...
    { "Alistair Leslie-Hughes", "d3dx9_36/tests: Add D3DXSaveSurfaceToFileInMemory D3DXIFF_DDS tests.", 1 },
    ...
    { "Austin English", "tdi.sys: Add a stub dll.", 3 },
    ...
    { "Dmitry Timoshkov", "kernel32: CompareStringW should abort on the first nonmatching character to avoid invalid memory access.", 1 },
    ...
    { "Hugh McMaster", "kernel32: Add a stub for SetConsoleFont.", 1 },
    { "Hugh McMaster", "kernel32: Implement GetLargestConsoleWindowSize.", 1 },
    { "Hugh McMaster", "kernel32/tests: Add tests for GetLargestConsoleWindowSize.", 1 },
    { "Hugh McMaster", "kernel32/tests: Refresh the console to clear the console font table.", 1 },
    { "Hugh McMaster", "wineconsole: Send the largest console window size information to the server.", 1 },
    ...
    { "Sebastian Lackner", "advapi32: Add stubs for RegCreateKeyTransacted[A/W] functions.", 1 },
    ...
    { "Sebastian Lackner", "include: Remove check for __WINE_WNE_PORT_H in winsock2.h.", 1 },
    ...
    { "Sebastian Lackner", "kernel32: Clamp maximum window size to screen buffer size.", 1 },
    ...
    { "Sebastian Lackner", "kernel32/tests: Add test for process object destruction.", 1 },
    ...
    { "Sebastian Lackner", "kernel32/tests: Remove unnecessary call to GetExitCodeProcess in process tests.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Allow to set debug registers separately in NtSetContextThread.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: ProcessDebugFlags should return debug_children flag instead of !debugger_present.", 1 },
    ...
    { "Sebastian Lackner", "server: Token_duplicate should not reference the original token, which will get destroyed on process exit.", 1 },
