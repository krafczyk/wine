...
wine_patch_data[] =
{
    ...
    { "Alistair Leslie-Hughes", "gdiplus: Add GdipCreateEffect stub.", 1 },
    ...
    { "Austin English", "fltmgr.sys: add stub dll.", 4 },
    ...
    { "Sebastian Lackner", "gdiplus: Do not use GdipAlloc and GdipFree in internal functions.", 1 },
