...
wine_patch_data[] =
{
    ...
    { "Erich E. Hoover", "Revert \"makefiles: Explicitly import libwine only for Windows builds.\".", 1 },
    ...
    { "Hugh McMaster", "reg: Add support for querying the registry with the /v and /ve switches.", 1 },
    { "Hugh McMaster", "reg: Query all values and subkeys in a specified key.", 1 },
    ...
    { "Sebastian Lackner", "kernel32: Fix handling of GetOverlappedResult when status remains STATUS_PENDING.", 1 },
    ...
    { "Sebastian Lackner", "vulkan: Initial implementation.", 1 },
