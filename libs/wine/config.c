...
wine_patch_data[] =
{
    ...
    { "Martin Storsjo", "vcruntime140: Add stubs for telemetry functions.", 1 },
    { "Martin Storsjo", "vcruntime140: Add the new MSVC 2015 compiler specific DLL.", 1 },
    { "Martin Storsjo", "vcruntime140: Hook up a function with a new name to the existing implementation.", 1 },
    ...
    { "Michael Müller", "ntdll: Reduce stack usage by storing sigset in static memory.", 1 },
    { "Michael Müller", "ntdll: Save stack in NtAllocateVirtualMemory by moving remote memory allocation into separate function.", 1 },
    ...
    { "Sebastian Lackner", "kernel32/tests: Add test to show that multiple user APCs are processed at once.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Do not check if object was signaled after user APC in server_select.", 1 },
