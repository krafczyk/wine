...
wine_patch_data[] =
{
    ...
    { "Dmitry Timoshkov", "gdiplus: Implement GdipCreateMetafileFromFile.", 1 },
    ...
    { "Huw Davies", "gdi32: Add back the extents test.", 1 },
    ...
    { "Sebastian Lackner", "secur32: Define missing gnutls_kx_algorithm_t values for old gnutls versions.", 1 },
