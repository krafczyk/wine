...
wine_patch_data[] =
{
    ...
    { "Andrew Eikum", "xaudio2: Ignore queued AL buffers after Stop.", 1 },
    ...
    { "Christian Costa", "msvcrt: Display noisy FIXME only once in pf_printf.", 1 },
    ...
    { "Józef Kucia", "wined3d: Invalidate INDEXBUFFER device state when bound index buffer is unloaded.", 1 },
    ...
    { "Michael Müller", "msvfw32: Use case insensitive compare in ICInfo for fourcc codes.", 1 },
    ...
    { "Sebastian Lackner", "Revert \"wined3d: Implement the initial texture data upload on top of wined3d_device_update_sub_resource().\".", 1 },
    ...
    { "Sebastian Lackner", "server: Map MAXIMUM_ALLOWED even if skipping access check.", 1 },
