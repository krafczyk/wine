...
wine_patch_data[] =
{
    ...
    { "Michael Müller", "advapi32: Set LastError to 0 in GetSidIdentifierAuthority.", 1 },
    ...
    { "Sebastian Lackner", "ntdll: Fix implementation of NtQueryInformationProcess for ProcessDebugFlags.", 1 },
